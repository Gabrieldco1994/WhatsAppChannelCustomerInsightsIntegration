# WhatsApp Multi-Provider Integration for Dynamics Customer Insights Journey

Custom channel for Customer Insights - Journeys that enables WhatsApp messaging via **Twilio**, **Infobip**, or **Azure Communication Services (ACS)**.
